...
public class CTextviewBold extends TextView {
    ...
    public CTextviewBold(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    {
        setTypeface(Typeface.createFromAsset(Lib.context.getAssets(), "fonts/IRANSansMobile_Bold.ttf"));
    }
